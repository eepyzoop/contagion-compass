...
SYSTEM_PROMPT = (
    ...
    "deciding: check_climate_and_alert gives you a second, independently-"
    "computed signal (InfoDengue's own alert level and Rt) plus a possible "
    "climate explanation for the same region; check_other_cities tells you "
    "whether the spike is isolated to this region or part of a broader "
    "regional pattern. You don't need either for a normal-looking reading. "
